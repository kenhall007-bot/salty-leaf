...
const offers = [
    {
        ...
        text: "Elevated floral arrangements for product launches, brand activation events, and corporate dinners.",
    },
    {
        title: "Private Celebrations",
        text: "Thoughtfully designed florals for milestone birthdays, anniversaries, baby showers, and intimate parties.",
    },
    {
        title: "Event Styling",
        text: "Curated floral installations, table styling, and prop hires designed to complement your venue.",
    },
    {
        title: "Custom Design",
        text: "Tailored concepts crafted specifically around the theme, branding, and scale of your Mandurah event.",
    },
]
...
const process = [
    {
        number: "01",
        title: "Enquire",
        text: "Share your event date, venue location, theme, and estimated scope.",
    },
    {
        number: "02",
        title: "Consultation",
        text: "We review venue layouts, color schemes, and custom floral requirements.",
    },
    {
        number: "03",
        title: "Design & Planning",
        text: "We prepare tailored floral concepts and detailed styling proposals.",
    },
    {
        number: "04",
        title: "Event Day",
        text: "Punctual delivery, professional installation, and post-event packdown.",
    },
]

export default function EventFloristMandurah() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Impactful floral design for corporate functions, private parties, and special events across Mandurah.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="mt-10 max-w-lg font-[family-name:var(--font-cormorant)] text-2xl font-medium leading-[1.15] text-[#25251f] sm:text-4xl">
                            Atmospheric floral styling created to transform spaces and captivate your guests.
                        </p>
                        ...
                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            Whether hosting an intimate dinner or a large scale corporate celebration in Mandurah, our bespoke arrangements craft an unforgettable experience.
                        </p>
            ...
            >
                <motion.img
                    ...
                    alt="Event florist Mandurah - floral centerpiece installation"
                    className="absolute inset-0 h-full w-full object-cover"
                />
                ...
                >
                    ...
                    >
                        Get in touch to discuss floral styling for your upcoming event.
                    </motion.p>
