...
const services = [
    {
        ...
        text: "Custom bridal bouquets, ceremony floral arches, and table centrepieces designed for Dawesville weddings.",
    },
    {
        title: "Funeral Flowers",
        text: "Thoughtful casket sprays, memorial wreaths, and sympathy flowers delivered with compassion.",
    },
    {
        title: "Event Flowers",
        text: "Bespoke floral styling for private celebrations, milestone birthdays, and community events.",
    },
    {
        title: "Same-Day Delivery",
        text: "Fresh seasonal flowers hand-delivered straight to homes and function spaces across Dawesville.",
    },
]

export default function FloristDawesville() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                <motion.img
                    ...
                    alt="Florist Dawesville - Salty Leaf floral arrangements"
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Seasonal, handcrafted floral arrangements for weddings, farewells, and events in Dawesville.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        <h2 className="font-[family-name:var(--font-cormorant)] text-5xl font-medium uppercase leading-[0.95] tracking-[-0.025em] text-[#1f211d] sm:text-6xl lg:text-6xl">
                            Florist Services in Dawesville
                        </h2>
                        ...
                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            Salty Leaf brings bespoke floral designs to residents and venues throughout Dawesville, nestled between the Peel-Harvey Estuary and the Indian Ocean.
                        </p>

                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            From waterside weddings near the Dawesville Cut to personal home deliveries, we craft beautiful arrangements tailored to your occasion.
                        </p>
                    </motion.div>
                    ...
                    >
                        <img
                            src="https://images.unsplash.com/photo-1508610048659-a06b669e3321?q=80&w=1200&auto=format&fit=crop"
                            alt="Florist Dawesville - fresh seasonal floral design"
            ...
            <section className="relative h-[550px] min-h-[500px] w-full overflow-hidden sm:h-[650px]">
                <motion.img
                    ...
                    alt="Florist Dawesville - floral delivery"
                    className="absolute inset-0 h-full w-full object-cover"
                />
                ...
                >
                    ...
                    >
                        Serving Dawesville &amp; Surrounding Areas
                    </motion.h2>
                    ...
                    >
                        Contact us today to arrange your flower delivery.
                    </motion.p>
