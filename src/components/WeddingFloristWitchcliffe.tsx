...
export default function WeddingFloristWitchcliffe() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                <motion.img
                    ...
                    alt="Wedding Florist Witchcliffe - bridal bouquets and forest wedding flowers"
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Bespoke wedding florals crafted with intention for ceremonies and receptions across Witchcliffe.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        <img
                            ...
                            alt="Wedding Florist Witchcliffe - outdoor wedding florals"
            ...
            >
                <motion.img
                    ...
                    src="/img2.JPG"
                    alt="Wedding Florist Witchcliffe - ceremony floral styling"
                    className="absolute inset-0 h-full w-full object-cover"
                />
