...
export default function WeddingFloristCowaramup() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                <motion.img
                    ...
                    alt="Wedding Florist Cowaramup - bridal bouquets and country wedding flowers"
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Bespoke wedding florals crafted with intention for ceremonies and receptions across Cowaramup.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            From rolling country vineyard ceremonies to rustic barn celebrations across Cowaramup, we source the most premium seasonal blooms for your wedding day.
                        </p>
                    ...
                    >
                        <img
                            src="/vinyard.png"
                            alt="Wedding Florist Cowaramup - vineyard ceremony florals"
            ...
            >
                <motion.img
                    ...
                    src="/img1.jpeg"
                    alt="Wedding Florist Cowaramup - ceremony floral styling"
                    className="absolute inset-0 h-full w-full object-cover"
                />
