...
export default function WeddingFloristMandurah() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Bespoke wedding florals crafted with intention for ceremonies and receptions across Mandurah.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            From intimate coastal ceremonies to grand reception celebrations in Mandurah, we source premium seasonal blooms tailored to your exact palette.
                        </p>
                    ...
                    >
                        <img
                            src="https://images.unsplash.com/photo-1561848355-890d054dc55a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="Wedding florist Mandurah - bridal bouquet"
