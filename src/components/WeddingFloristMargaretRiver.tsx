...
export default function WeddingFloristMargaretRiver() {
    return (
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                <motion.img
                    ...
                    src="/vinyard.png"
                    alt="Wedding Florist Margaret River - bridal bouquets and vineyard wedding flowers"
                ...
                >
                    <div className="flex flex-col items-start">
                        ...
                        >
                            Wedding Florist Margaret River
                        </motion.h1>
                        ...
                        >
                            Bespoke wedding florals crafted with intention for ceremonies and receptions across Margaret River.
                        </motion.p>
                ...
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="mt-7 max-w-md font-[family-name:var(--font-cormorant)] text-lg font-medium leading-[1.35] text-[#35352e] sm:text-2xl">
                            From vineyard estate ceremonies to grand reception celebrations across Margaret River and the Southwest region, we source the most premium seasonal blooms for your wedding day.
                        </p>
                    ...
                    >
                        <img
                            ...
                            alt="Wedding Florist Margaret River - bridal bouquet and ceremony florals"
            ...
            >
                <motion.img
                    ...
                    alt="Wedding Florist Margaret River - ceremony floral styling"
                    className="absolute inset-0 h-full w-full object-cover"
                />
